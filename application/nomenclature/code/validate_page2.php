<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $courseNo = filter_var($_POST['courseNum'] , FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $courseName = filter_var($_POST['courseName'] , FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $instructor = filter_var($_POST['instructor'] , FILTER_SANITIZE_FULL_SPECIAL_CHARS);
